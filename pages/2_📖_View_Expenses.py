...
# Generate and Display AI Insights for Logged-In Users
st.subheader("AI Suggestions 🤖")

# Fetch AI insights
ai_suggestions = account.generate_ai_insights()

if ai_suggestions:
    for suggestion in ai_suggestions:
        st.write(f"✅ {suggestion}")
else:
    st.write("No suggestions available. Add more transactions to see AI insights.")
