...
<div style="background: linear-gradient(45deg, #FF6B6B, #4ECDC4); padding: 20px; border-radius: 10px; box-shadow: 0 0 20px rgba(78, 205, 196, 0.5);">
...
<div style="background: linear-gradient(135deg, #FF6B6B, #4ECDC4); padding: 15px; border-radius: 8px; margin: 20px 0;">
...
<div style="background: #1F222E; padding: 20px; border-radius: 8px;">
...
<div style="background: linear-gradient(135deg, #4ECDC4, #FF6B6B); padding: 2px; border-radius: 10px; margin: 20px 0;">
<div style="background: #1F222E; padding: 20px; border-radius: 8px;">
