...
from utils.Budget_Baba import get_budget_insights
...
with st.sidebar:
    st.markdown(
        ...
        <div class="chatbot-container" onclick="document.getElementById('chat_expander').click();">
            ...
            <div class="chatbot-name">Budget-Baba Assistant</div>
        </div>
        """,
    ...
    with st.expander("💬 Chat with Budget-Baba Assistant", expanded=False):
